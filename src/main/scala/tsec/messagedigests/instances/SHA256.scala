...
object SHA256 extends DeriveHashTag[SHA256]("SHA-256"){
  override implicit lazy val jPureHasher: PureHasher[MessageDigest, SHA256] = pureJavaHasher[SHA256]
  override implicit lazy val jHasher: JHasher[SHA256] = JHasher[SHA256]
}
