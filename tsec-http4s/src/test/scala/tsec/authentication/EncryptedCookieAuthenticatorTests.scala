...
class EncryptedCookieAuthenticatorTests extends AuthenticatorSpec[AuthEncryptedCookie[?, Int]] {
      ...
      def extractFromResponse(response: Response[IO]): OptionT[IO, AuthEncryptedCookie[A, Int]] = {
        ...
        cookieOpt match {
          ...
          case Some(rawCookie) =>
            ...
            } yield AuthEncryptedCookie.build[A, Int](internal, coerced, TSecCookieSettings.fromCookie(rawCookie))
        }
      }
