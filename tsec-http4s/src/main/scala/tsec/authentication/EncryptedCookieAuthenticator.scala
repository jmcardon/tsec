...
object EncryptedCookieAuthenticator {
  ...
  def withBackingStore[F[_], Alg: AuthEncryptor, I: Decoder: Encoder, V](
      ...
      key: SecretKey[Alg]
  )(implicit M: MonadError[F, Throwable]): EncryptedCookieAuthenticator[F, Alg, I, V] =
    new EncryptedCookieAuthenticator[F, Alg, I, V] {

      def withKey(newKey: SecretKey[Alg]): EncryptedCookieAuthenticator[F, Alg, I, V] =
      ...
      def withSettings(settings: TSecCookieSettings): EncryptedCookieAuthenticator[F, Alg, I, V] =
        withBackingStore[F, Alg, I, V](
          settings,
          tokenStore,
          identityStore,
      ...
      def withIdentityStore(newStore: BackingStore[F, I, V]): EncryptedCookieAuthenticator[F, Alg, I, V] =
        withBackingStore[F, Alg, I, V](
          settings,
          tokenStore,
          newStore,
      ...
      ): EncryptedCookieAuthenticator[F, Alg, I, V] =
        withBackingStore[F, Alg, I, V](
          settings,
          newStore,
          identityStore,
