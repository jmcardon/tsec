...
private[tsec] trait GenericHashConstants {
  val crypto_generichash_blake2b_BYTES_MIN = 16L

  val crypto_generichash_blake2b_BYTES_MAX = 64L

  val crypto_generichash_blake2b_BYTES = 32

  val crypto_generichash_blake2b_KEYBYTES_MIN = 16L

  val crypto_generichash_blake2b_KEYBYTES_MAX = 64L

  val crypto_generichash_blake2b_KEYBYTES = 32L

  val crypto_generichash_blake2b_SALTBYTES = 16L

  val crypto_generichash_blake2b_PERSONALBYTES = 16L
}
