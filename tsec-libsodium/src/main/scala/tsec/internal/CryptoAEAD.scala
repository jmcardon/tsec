...
trait CryptoAEADConstants {
  ...
  val crypto_aead_aes256gcm_KEYBYTES = 32L

  val crypto_aead_aes256gcm_NSECBYTES = 0L

  val crypto_aead_aes256gcm_NPUBBYTES = 12L

  val crypto_aead_aes256gcm_ABYTES = 16L
